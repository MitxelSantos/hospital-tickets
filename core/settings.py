...
SECRET_KEY = 'django-insecure-%h%$e$qr-@lm3x(f)xl#30+p^bnq3fxf)93eado@n+&(pl$ag('

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['.render.com', 'tu-url-de-render.onrender.com']
...
TIME_ZONE = 'America/Bogota' # Hora local de Colombia
...
# Configuración para WhiteNoise y Static Files
